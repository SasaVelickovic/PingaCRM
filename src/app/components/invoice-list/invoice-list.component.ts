...
export class InvoiceListComponent implements OnInit, OnDestroy {
  ...
  onProjectSelect2(e: any) {
    ...
    if (e.value > 0) {
      ...
      this.currentProjectId = e.value;
    }
    else {
      this.unitCheck = e.value
      this.isProject = false;
      this.setValidations();
    }
  }
  ...
  onUnitSelect(e: any) {
    ...
    this.location.replaceState(SplitPath + '/' + e.value)
    ...
    if (e.value > 0) {
      ...
      this.setInitPageData(e.value, 1);
    }
  ...
  getPageData(e: any) {
    ...
    if (this.companyId < 1 || this.flag === 'none') {
      ...
      this.setInitPageData(buyerID, e.pageNo);
    }
  }
